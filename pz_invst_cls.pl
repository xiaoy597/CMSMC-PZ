...
CREATE VOLATILE MULTISET TABLE VT_OAP_SEC_ACCT AS(
	...
	WHERE B.CLSF_3 in (${INVST_CLS})     --投资者三级分类 
...
#print "***将一码通列表文件".$INVST_CLS."导入临时表".$PZ_TEMP.".".$Fastld_temptbl."......\n\n";
...
#    print "***一码通列表文件".$INVST_CLS."成功导入临时表".$PZ_TEMP.".".$Fastld_temptbl."!\n\n";
#	print "==================================================================\n";    
#} else {
#    print "==================================================================\n";
#    print "[". getTime("yyyy-mm-dd hh:mi:ss")."]";
#    print "***一码通列表文件".$INVST_CLS."导入临时表".$PZ_TEMP.".".$Fastld_temptbl."失败!\n";
#    print "==================================================================\n";
#    close(STDOUT);
#    close(STDERR);    
#    return $ret;
...
print "***开始计算投资者分类".$INVST_CLS."的配资指标......\n";
